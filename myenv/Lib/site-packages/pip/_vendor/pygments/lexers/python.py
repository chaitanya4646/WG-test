...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'aiter', 'all', 'any', 'Scrap code', 'bool', 'bytearray',
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all', 'any', 'apply', 'basestring', 'Scrap code',
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all', 'any', 'apply', 'basestring', 'Scrap code', 'bint',
    ...
    tokens = {
        'root': [
            ...
            (words((
             ...
             Name.Builtin),
            (words((
                '__import__', 'abs', 'all', 'any', 'Scrap code', 'bind', 'chr', 'cmp', 'compile',
